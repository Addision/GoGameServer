...
func (pm *PosListManager) GetScreenSurround(x, y int) utils.SetUInt64 {
	xplayers := pm.xList.GetScreenPlayers(x)
	yPlayers := pm.yList.GetScreenPlayers(y)

	var players utils.SetUInt64
...
func (pm *PosListManager) GetViewSurround(x, y int) utils.SetUInt64 {
