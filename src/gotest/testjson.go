...
var json_str2 = "[false,false,false,false,false,false,true,true,1,false,false,false,{\"fPercent\":80,\"bIsOpen\":true},{\"fPercent\":20,\"bIsOpen\":true},true,{\"nLevel\":1,\"bIsOpen\":true},{\"nLevel\":1,\"bIsOpen\":true},{\"nLevel\":1,\"bIsOpen\":true},{\"tToggleList\":[false,false,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true,true],\"bIsOpen\":true},false]"
...
func main() {
	...
	res2, err2 := simplejson.NewJson([]byte(json_str2))
	if err2 != nil {
		fmt.Printf("%v\n", err2)
		return
	}
	res3, err3 := res2.Array()
	if err3 != nil {
		fmt.Printf("%v\n", err3)
		return
	}
